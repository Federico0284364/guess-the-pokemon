...
export class Convert {
    public static JSONtoPokemon(json: string): PokemonSpecies {
        return cast(JSON.parse(json), r("Welcome"));
    }

    public static pokemonSpecieToJson(value: PokemonSpecies): string {
...
const typeMap: any = {
    "Welcome": o([
        ...
        { json: "form_descriptions", js: "form_descriptions", typ: a(r("FormDescription")) },
        ...
        { json: "habitat", js: "habitat", typ: null },
        ...
        { json: "pal_park_encounters", js: "pal_park_encounters", typ: a("any") },

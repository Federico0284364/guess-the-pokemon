...
export default function GameOption({selectedDifficulty}) {
	...
	return (
		<div onClick={handleClick} className="hover:scale-103 hover:translate-y-[-8px] transition-[2] shadow-lg shadow-black flex flex-col items-center rounded-2xl justify-around border-1 cursor-pointer bg-orange-400 pb-4">

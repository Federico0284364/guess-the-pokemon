...
import { StoreState, newGame } from "../../store/gameSlice.js";
import { calculateTotalScore, capitalize } from "../../utils/functions.js";
    ...
    <header className="flex justify-between md:justify-normal items-center gap-6 sm:gap-0 mb-4">
      ...
      {device != "small" && (
        <ul className="flex justify-self-end items-center gap-0 lg:gap-2 ml-3">
          {pokemonList.slice(0, round).map((guessedPokemon, index) => {

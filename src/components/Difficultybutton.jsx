	...
	return (
		<label className="text-xl mt-1">
			...
			{isChecked && chosenDifficulty === "Easy" ? (
				...
				<>
					<p className="font-light text-sm w-50 ml-4">
						Can you identify the Pokémon’s name, type, and extra
						details?
					</p>

					<p className="dropdown-content mt-5 text-md w-50 ml-4">
						Rules for hard mode:
					</p>
					<ul className="flex  flex-col gap-2 text-sm w-50 ml-8 mt-2 list-disc">
